import Clarifai from './clarifai-basic';

var clarifai = new Clarifai({ id: '', secret: '' });
...
clarifai.positive(phishPositives[0], 'phish')
  .then(() => clarifai.negative(phishNegatives[0], 'phish'))
  .then(() => clarifai.train('phish'))
  .then(() => clarifai.predict('http://farm3.static.flickr.com/2161/2141620332_2b741028b3.jpg', 'phish'))
